...
namespace fruit2.Module {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed partial class fruit2Module : ModuleBase {
        static fruit2Module() {
            ...
            // #if DEBUG
            // Database.SetInitializer(new DropCreateDatabaseIfModelChanges<fruit2DbContext>());
            // #endif 
        }
        public fruit2Module() {
            InitializeComponent();
